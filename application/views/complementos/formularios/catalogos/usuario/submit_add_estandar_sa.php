<form class="form-horizontal style-form" method="post" action="<?php echo base_url(); ?>configuracion/insertar_usuario_estandar" enctype="multipart/form-data">
  <section>                            
    <div align="center">
      <div class="form-group">
        <label class="col-sm-2 col-sm-2 control-label">Folio del Administrador:</label>
        <div class="col-sm-3">
            
            <select class="form-control" name="folio" id="folio">
              <option>SELECCIONE UNA OPCION</option>
              <?php 
                for ($filaX=0; $filaX <count($usuarios) ; $filaX++) 
                {
                echo 
                '<option value="'.$usuarios[$filaX]['Usufolio'].'">'.$usuarios[$filaX]['Usufolio'].' => '.$usuarios[$filaX]['Usunombre'].'</option>';     
                }
              ?>
            </select>
          </div>

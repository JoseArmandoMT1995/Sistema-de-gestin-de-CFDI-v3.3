    ...
    */
    ...
    if($cliente->timbrar(
        ...
        if($cliente->xml){
            ...
            //header();
            print_r($comprobante);
            //header("Location: ".base_url()."comprobantes/generar_xml_timbrado/".$cliente->xml);
        ...
        */
        echo "<h1><center>Timbrado exitoso1</center></h1>";
        //header('Location:'.$comprobante.".xml");
        //header();
        //header("Location: ".base_url()."comprobantes/generar_xml_timbrado");
    }else{

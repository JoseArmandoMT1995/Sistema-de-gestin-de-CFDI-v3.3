<div class="showback">
  ...
  <form class="form-horizontal style-form" method="post" action="<?php echo base_url(); ?>Informacion_General/update_usuario/<?php echo $usuario_editado['Usuclave']?>/B" enctype="multipart/form-data">
    <section>                            
      <div align="center">
        <div class="form-group">
          <p><?php print_r($usuario_editado); ?></p>
        </div>
        <div class="form-group">

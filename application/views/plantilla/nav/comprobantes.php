<aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a  href="<?=base_url()?>Informacion_General">
                  <img src="<?=base_url()?>usuarios/fotos_perfil/<?php echo $foto_perfil?>" class="img-circle" width="60" height="60"></a></p>
                  <h5 class="centered">
                    <?php
                  ...
                  <li class="sub-menu">
                    <?php
                      ...
                      if ($acceso=='si') {
                      $this->load->view('complementos/nav/activa/comprobante');
                      }
                      else
                      {
                      //$this->load->view('pagina/sin_privilegios');

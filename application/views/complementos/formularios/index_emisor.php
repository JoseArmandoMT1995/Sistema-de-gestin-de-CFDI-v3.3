    <form class="form-horizontal style-form" method="post" action="<?php echo base_url(); ?>catalogos/submit_add_receptor">
            <div class="showback">
               ...
               <div class="showback">
                    ...
                    <table border="1">
                      <tr>
                        <th colspan="2">IMPRIMIR REPORTE </th>
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                          <a href="<?php echo base_url(); ?>catalogos/documento/receptor/excel"><button type="button" class="btn btn-theme03"><i class="fa fa-file-excel-o"></i> IMPRIMIR EN EXCEL</button></a>
                        </center>
                        </td>

...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(0, 15, 'REGISTROS DE RECEPTORES', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->setX(2);
$pdf->SetFont('','',5);
$pdf->Cell(10, 10, 'Id_receptor'                , 1, 0, 'A', 0, '', 0);
...
for($i=0;$i<count($datos);$i++){
    $pdf->setX(2);
                $pdf->Cell(10, 10, $datos[$i]->Id_receptor           , 1, 0, 'C', 0, '', 0);
                $pdf->Cell(15, 10, $datos[$i]->RFC_receptor          , 1, 0, 'C', 0, '', 0);
                $pdf->Cell(10, 10, $datos[$i]->UsoCFDI        , 1, 0, 'C', 0, '', 0);
                $pdf->Cell(10, 10, $datos[$i]->Tipo_perosna_receptor , 1, 0, 'C', 0, '', 0);
                $pdf->Cell(20, 10, $datos[$i]->Rason_social_receptor , 1, 0, 'C', 0, '', 0);
                ...
                $pdf->Cell(10, 10, $datos[$i]->RFC_receptor          , 1, 0, 'C', 0, '', 0);
                ...
                $pdf->Cell(10, 10, $datos[$i]->Email_receptor        , 1, 0, 'C', 0, '', 0);
                $pdf->Cell(10, 10, $datos[$i]->Telefono_receptor     , 1, 1, 'C', 0, '', 0);
    }

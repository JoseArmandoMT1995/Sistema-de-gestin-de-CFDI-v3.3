<div class="showback">
	             ...
	             <form class="form-horizontal style-form" method="post" action="<?php echo base_url(); ?>catalogos/update_receptor/<?php echo $receptores_editado['Id_receptor']?>">
                          <div class="form-group">
                              ...
                              <label class="col-sm-1 col-sm-1 control-label">UsoCFDI:</label>
                              <div class="col-sm-2">
                                  <input type="text" class="form-control round-form" name="Regimen_fiscal" placeholder="UsoCFDI" <?php echo "value='".$receptores_editado['UsoCFDI']."'";?>>
                              </div>

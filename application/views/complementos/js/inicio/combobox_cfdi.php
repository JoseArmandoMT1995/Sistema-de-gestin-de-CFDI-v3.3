    ...
    $('#combobox_emisor').on("change",function()
    {
        ...
        {    
            ...
            .done(function(info){
                ...
                console.log("UsoCFDI: " +emisor['UsoCFDI']);
    ...
    $('#combobox_receptor').on("change",function()
    {
        ...
        {     
            ...
            .done(function(info){
                ...
                $("#receptor_uso_cfdi").val(emisor['UsoCFDI']);
    ...
    {   
        ...
        {     
            ...
            .done(function(info){
                ...
                $("#Impuesto_Ieps_Ret").val(concepto['Impuesto_ret_Ieps']);

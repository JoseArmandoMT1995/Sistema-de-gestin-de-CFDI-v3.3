...
include(APPPATH . 'third_party/FacturacionModerna-PHP-master/FacturacionModerna/FacturacionModerna.php');
...
function pruebaTimbrado() {
    ...
    $archivo_cer = base_url()."usuarios/certificados/20001000000300022762.cer";
    $archivo_pem = base_url()."usuarios/certificados/20001000000300022762.key.pem";
    ...
    */
    ...
    $cliente = new FacturacionModerna(
        $url_timbrado, 
        $parametros, 
        $debug);
        ...
        $opciones))
    {
        ...
        $comprobante = base_url().'usuarios/cfdi/'.$cliente->UUID;
        ...
        echo "<h1><center>Timbrado exitoso</center></h1>";
        //header('Location:'.$comprobante.".xml");
        //header();
    }
    else
    {
...
function sellarXML($cfdi, $numero_certificado, $archivo_cer, $archivo_pem) {
    ...
    $XSL->load(base_url().'usuarios/xslt33/cadenaoriginal_3_3.xslt');
...
function generarXML ($rfc_emisor) {
    ...
    //escoje el archivo xml
    $cfdi = <<<XML
<?xml version="1.0" encoding="UTF-8"?>
<cfdi:Comprobante xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd" Version="3.3" Serie="A" Folio="01" Fecha="$fecha_actual" Sello="" FormaPago="03" NoCertificado="20001000000200000192" Certificado="" CondicionesDePago="CONTADO" SubTotal="1850" Descuento="175.00" Moneda="MXN" Total="1943.00" TipoDeComprobante="I" MetodoPago="PUE" LugarExpedicion="68050">
  <cfdi:Emisor Rfc="$rfc_emisor" Nombre="BUSSINES SYSTEM DE MEXICO SA DE CV" RegimenFiscal="601"/>
  <cfdi:Receptor Rfc="XAXX010101000" Nombre="ESTO ES UNA PRUEBA DE CIVERWIN E1" UsoCFDI="G01"/>
  <cfdi:Conceptos>
